...
/*************************************************************************************************/
/**************** Table cell editor for resource tag (name/org/group/role/alias) *****************/
/*************************************************************************************************/

class EditorResourceTag extends EditorText
{

  /**************************************** constructor ******************************************/
  public EditorResourceTag( int columnIndex, int row )
  {
    // create editor
    ...
    addListener( ( observable, oldText, newText ) ->
    {
      ...
      String clash = JPlanner.plan.resources.initialsClash( tidy, -1 );
      if ( clash != null )
        error = clash;
